...
export class CreateUsersAndAuth1704067200000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX idx_user_role_unique ON user_role_mappings(user_id, role_id);
    `);
  }
